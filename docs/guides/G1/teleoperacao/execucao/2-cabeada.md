...
É recomendado fazer primeiramente a teleoperação com o [Quest via wifi](/guides/G1/teleoperacao/execucao/via-wifi)

Seu setup deve estar assim para prosseguir, a principal vantagem da teleoperação cabeada é a total independência de internet:
...
Quest 3:       Cabo USB-C conectado ao Host
```
## PC2
```sh
ssh 192.168.123.164
...
Acesse via `localhost:8012`, o vuer não irá funcionar pois necessita de internet.
...
2. Abra o localhost:8012 no Quest
